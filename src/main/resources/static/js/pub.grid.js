...
,_defaults = {
	...
	,valueFilter : false // value filter /*function (val){return val;}*/
	,autoResize : {	//리사이즈 설정
...
Plugin.prototype ={
	...
	*/
	...
	,valueFormatter : function (_idx ,thiItem, rowItem, addEle){
		...
		if(this.options.valueFilter !== false){
			itemVal = this.options.valueFilter.call(null,{idx : _idx , colInfo:thiItem, item: rowItem, value : itemVal});
		}
